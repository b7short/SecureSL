                ...
                if(isset($_POST['login'])) {
                    ...
                    if(password_verify($user_password, $result['user_password'])) {
                        if($result['is_active'] == 1) {
                            ...
                            echo "<div class='notification'>You are not verified user <form method='POST'><input type='text' name='user_name' hidden><input text='email' name='user_email' hidden><input class='resend' class type='submit' value='click here to verify' name='resend'></form></div>";
                        }
                    } else {
